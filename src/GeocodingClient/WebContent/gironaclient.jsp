...
<h1>This is a test client for the Girona address REST Service</h1>
<form class="form-horizontal" role="form">
  <div class="form-group">
    <label class="control-label col-sm-2"  for="address">address:</label>
    <div class="col-sm-10">
    <input type="text" class="form-control" id="address" placeholder="Carrer de Bonastruc de Porta">
    </div>
  </div>
  <div class="form-group"> 
 ...
 $(document).ready(function(){
     ...
     $("#submit").click(function(event){
         ...
         $.ajax({
             ...
             dataType:"json",
             url:  "http://hub.geosmartcity.eu/GironaGeocoderServer/geo/RestService/getaddress",
             //url: "http://localhost:8080/GironaGeocoderServer/geo/RestService/getaddress",
